...
function App() {
  ...
  const shop_btn_shirt = () =>{
    window.location.hash = "#/shop?tag=Shirt";
  }
  const shop_btn_hoodie = () =>{
    window.location.hash = "#/shop?tag=Hoodie";
  }
  const shop_btn_accessories = () =>{
    window.location.hash = "#/shop?tag=Accessories";
  }
  const shop_btn_tobag = () =>{
    window.location.hash = "#/shop?tag=Tobag";
  }
  ...
  return (
    <div className="P1" style={darkMode ? {background:"black"}:{background:"white"}}>
      ...
      <div className='container'>
        <video className='bg_vid' autoPlay loop muted playsInline style={darkMode ? {display:"flex"}:{display:"none"}}>
