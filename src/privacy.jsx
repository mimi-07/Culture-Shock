  ...
  return (
    <div className='P1' style={darkMode ? {background:"black"}:{background:"white"}}>
      ...
      <div className="navbar_1" style={darkMode ? {background:"rgba(0,0,0,40)",backdropFilter:"10px", boxShadow:"0 0 3px #fff, 0 0 30px #e60073, 0 0 40px #e60004"}:{}}>
        ...
        <div className='text'>
            <h1 className='title' style={darkMode ? {color:"white"}:{}}>Privacy policy</h1>
            <p>Last updated: February 12, 2025</p>
            <p>This Privacy Policy describes how culture shock clothing (the "Site", "we", "us", or "our") collects, uses, and discloses your personal information when you visit, use our services, or make a purchase from cltrshck.myshopify.com (the "Site") or otherwise communicate with us regarding the Site (collectively, the "Services"). For purposes of this Privacy Policy, "you" and "your" means you as the user of the Services, whether you are a customer, website visitor, or another individual whose information we have collected pursuant to this Privacy Policy. Please read this Privacy Policy carefully.</p>
            <h1 style={darkMode ? {color:"white"}:{}}>Changes to This Privacy Policy</h1>
            ...
            <h1 style={darkMode ? {color:"white"}:{}}>How We Collect and Use Your Personal Information</h1>
            <p>To provide the Services, we collect personal information about you from a variety of sources, as set out below. The information that we collect and use varies depending on how you interact with us.<br/>In addition to the specific uses set out below, we may use information we collect about you to communicate with you, provide or improve or improve the Services, comply with any applicable legal obligations, enforce any applicable terms of service, and to protect or defend the Services, our rights, and the rights of our users or others.</p>
            <h1 style={darkMode ? {color:"white"}:{}}>What Personal Information We Collect</h1>
            ...
            <h4>
                ...
                Order information including your name, billing address, shipping address, payment confirmation, email address, and phone number.<br/>
                Account information including your username, password, security questions and other information used for account security purposes.<br/>
                Customer support information including the information you choose to include in communications with us, for example, when sending a message through the Services.<br/>
            </h4>
            ...
            <h2 style={darkMode ? {color:"white"}:{}}>Information We Collect about Your Usage</h2>
            ...
            <h2 style={darkMode ? {color:"white"}:{}}>Information We Obtain from Third Parties</h2>
            ...
            <h4>
                Companies who support our Site and Services, such as Shopify.<br/>
            ...
            <h2 style={darkMode ? {color:"white"}:{}}>How We Use Your Personal Information</h2>
            <h4>
                Providing Products and Services. We use your personal information to provide you with the Services in order to perform our contract with you, including to process your payments, fulfill your orders, to send notifications to you related to your account, purchases, returns, exchanges or other transactions, to create, maintain and otherwise manage your account, to arrange for shipping, facilitate any returns and exchanges and other features and functionalities related to your account. We may also enhance your shopping experience by enabling Shopify to match your account with other Shopify services that you may choose to use. In this case, Shopify will process your information as set forth in its Privacy Policy and Consumer Privacy Policy.<br/>
                Marketing and Advertising. We may use your personal information for marketing and promotional purposes, such as to send marketing, advertising and promotional communications by email, text message or postal mail, and to show you advertisements for products or services. This may include using your personal information to better tailor the Services and advertising on our Site and other websites. If you are an EEA resident, the legal basis for these data processing activities is our legitimate interest in selling our products, according to Art. 6 (1) (f) GDPR.<br/>
                Security and Fraud Prevention. We use your personal information to detect, investigate or take action regarding possible fraudulent, illegal or malicious activity. If you choose to use the Services and register an account, you are responsible for keeping your account credentials safe. We highly recommend that you do not share your username, password, or other access details with anyone else. If you believe your account has been compromised, please contact us immediately. If you are an EEA resident, the legal basis for these data processing activities is our legitimate interest in keeping our website secure for you and other customers, according to Art. 6 (1) (f) GDPR.<br/>
            ...
            <h2 style={darkMode ? {color:"white"}:{}}>Cookies</h2>
            ...
            <h2 style={darkMode ? {color:"white"}:{}}>How We Disclose Personal Information</h2>
            ...
            <table>
                ...
                <tr>
                    <th>
                        <ol>Identifiers such as basic contact details and certain order and account information</ol>
                        <ol>Commercial information such as order information, shopping information and customer support information</ol>                       Commercial information such as order information, shopping information and customer support information
                        <ol>Internet or other similar network activity, such as Usage Data</ol>
                        <ol>Geolocation data such as locations determined by an IP address or other technical measures</ol>
                    </th>
                    <th>
                      <ol>Vendors and third parties who perform services on our behalf (such as Internet service providers, payment processors, fulfillment partners, customer support partners and data analytics providers)</ol>
                      <ol>Business and marketing partners</ol>
                      <ol>Affiliates</ol>
                    </th>
                </tr>
            </table>
            ...
            <h2 style={darkMode ? {color:"white"}:{}}>Third Party Websites and Links</h2>
            ...
            <h2 style={darkMode ? {color:"white"}:{}}>Children's Data</h2>
            ...
            <h2 style={darkMode ? {color:"white"}:{}}>Security and Retention of Your Information</h2>
            ...
            <h2 style={darkMode ? {color:"white"}:{}}>Your Rights</h2>
            ...
            <h2 style={darkMode ? {color:"white"}:{}}>Complaints</h2>
            ...
            <h2 style={darkMode ? {color:"white"}:{}}>International Users</h2>
            ...
            <h2 style={darkMode ? {color:"white"}:{}}>Contact</h2>
            <p>Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please call or email us at cltrshckclothing@gmail.com or contact us at 1 Lawson Drive, Timperley, Altrincham, ENG, WA15 6LZ, GB.</p>
